...
// FIXME: the dedent caused finishTag calls will fail to do the right thing for block attributes being closed,
// causing content delimiter checking to be skipped.
